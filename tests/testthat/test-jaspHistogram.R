test_that("jaspHistogram: default, grouped, manual bins, and density-shade variants", {
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_default))
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_grouped))
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_manual))
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_density))
