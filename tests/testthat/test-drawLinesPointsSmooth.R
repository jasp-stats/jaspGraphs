test_that("drawLines, drawPoints, drawSmooth: basic rendering and group mapping", {
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_lines))
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_lines_g))
  vdiffr::expect_doppelganger("drawLines-grouped", p_lines_g)

  # drawPoints
  p_points <- drawPoints(dat = dat1)
  testthat::expect_true(ggplot2::is.ggplot(p_points))
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_points_g))
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_smooth_dat))
  ...
  testthat::expect_true(ggplot2::is.ggplot(p_smooth_graph))
